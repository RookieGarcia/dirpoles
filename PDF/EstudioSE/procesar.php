...
class GenerarPDF
{
    public static function crearPDF($rutaPDF)
    {
        ...
        $nombre = utf8_decode(isset($_POST['nombre']) ? $_POST['nombre'] : '');
        $lugarFechaConcat = isset($_POST['nacimiento']) && isset($_POST['fecha_nacimiento']) ? $_POST['nacimiento']. ' - ' . DateTime::createFromFormat('Y-m-d', $_POST['fecha_nacimiento'])->format('d/m/Y') : '';
        ...
        $ocupacion = utf8_decode(isset($_POST['ocupacion']) ? $_POST['ocupacion'] : '');
        ...
        $nombre1 = utf8_decode(isset($_POST['nombre1']) ? $_POST['nombre1'] : '');
        ...
        $nombre2 = utf8_decode(isset($_POST['nombre2']) ? $_POST['nombre2'] : '');
        ...
        $nombre3 = utf8_decode(isset($_POST['nombre3']) ? $_POST['nombre3'] : '');
        ...
        $nombre4 = utf8_decode(isset($_POST['nombre4']) ? $_POST['nombre4'] : '');
        ...
        $nombre5 = utf8_decode(isset($_POST['nombre5']) ? $_POST['nombre5'] : '');
        ...
        $pdf->Image('pdf/estudiose/EstudioSocioEconomico.png', 0, 0, 210, 297); // Ajusta las coordenadas y dimensiones según la imagen y tamaño de página (A4 en mm)
