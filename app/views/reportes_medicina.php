...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1>Bienvenido al área de reportes de medicina</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="content">
        <div class="container-fluid">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header bg-navy">
                  <h3 class="card-title">Reporte de medicina</h3>
                </div>
                <div class="card-body">
          ...
          <div id="contenedor_medicina" class="row" style="display:none;">
            <div class="col-12">
              <div class="card">
                <div class="card-header bg-navy">
                ...
                <div class="card-body">
                  <table id="tabla_medicina" class="table table-bordered table-striped table-hover text-center">
                    <thead>
                      <tr class="bg-navy">
                        <th>Fecha</th>
                        <th>Nombres</th>
  ...
  <script src="dist/js/reportes/medicina.js"></script>
