...
<section class="content">
    ...
    <?php if ($datos['motivo'] === 'general'): ?>
        <div id="formDiagnosticoGeneral" class="form-section">
            <form action="index.php?action=psicologia_actualizar" method="POST">
                <input type="hidden" name="id_psicologia" value="<?php echo $datos['id_psicologia']; ?>">
                <div class="card">
                    <div class="card-header bg-navy">
                        <h3 class="card-title">Editar Formulario Diagnóstico General</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="id_patologia" id="id_patologia" class="custom-select form-control-border" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="diagnostico" name="diagnostico" rows="3"><?php echo htmlspecialchars($datos['diagnostico']); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="tratamiento_gen" name="tratamiento_gen" rows="3"><?php echo htmlspecialchars($datos['tratamiento_gen']); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group w-100">
                                    ...
                                    <a href="index.php?action=psicologia_listar" class="btn btn-danger w-50">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <?php if ($datos['motivo'] === 'cambio'): ?>
        <div id="formCambioCarrera" class="form-section">
            <form action="index.php?action=psicologia_actualizar_2" method="POST">
            <input type="hidden" name="id_psicologia" value="<?php echo $datos['id_psicologia']; ?>">
                <div class="card">
                    <div class="card-header bg-navy">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="motivo_otro" name="motivo_otro" rows="3"><?php echo htmlspecialchars($datos['motivo_otro']); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="observacionesCambio" name="observaciones" rows="3"><?php echo htmlspecialchars($datos['observaciones']); ?></textarea>
                            </div>
                        </div>

                        <div class="d-flex align-items-center mb-3">
                            <!-- Input Disabled para mostrar los detalles del beneficiario -->
                            <input type="text" id="nombre_beneficiario_cambio" class="form-control" value="<?php echo htmlspecialchars($datos['nombre_beneficiario'] . ' ' . $datos['apellido_beneficiario'] . ' - ' . $datos['cedula_beneficiario']); ?>" disabled style="margin-bottom: 0;" disabled style="flex: 1;">
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="motivo_otro_retiro" name="motivo_otro" rows="3"><?php echo htmlspecialchars($datos['motivo_otro']); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="observacionesRetiro" name="observaciones" rows="3"><?php echo htmlspecialchars($datos['observaciones']); ?></textarea>
                            </div>
                        </div>

                        <div class="d-flex align-items-center mb-3">
                            <!-- Input Disabled para mostrar los detalles del beneficiario -->
                            <input type="text" id="nombre_beneficiario_retiro" class="form-control" value="<?php echo htmlspecialchars($datos['nombre_beneficiario'] . ' ' . $datos['apellido_beneficiario'] . ' - ' . $datos['cedula_beneficiario']); ?>" disabled style="margin-bottom: 0;" disabled style="flex: 1;">
                        </div>
