var table = $('#tabla_fames').DataTable({
    "responsive": true,
    "autoWidth": false,
    "paging": true,
    "lengthChange": true,
    ...
    "buttons": [{
      ...
      {
        text: '<i class="fas fa-plus-circle"></i> Crear FAMES',
        className: 'btn btn-info',
        action: function() {
          window.location.href = 'index.php?action=vista_trabajo_social&formulario=fames';
        }
      }
    ],
    "language": {
