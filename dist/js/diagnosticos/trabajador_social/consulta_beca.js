var table = $('#tabla_becas').DataTable({
    "scrollX": true,
    "responsive": true,
    "autoWidth": false,
    "paging": true,
    ...
    "buttons": [{
      ...
      {
        text: '<i class="fas fa-plus-circle"></i> Crear Beca',
        className: 'btn btn-info',
        action: function() {
          window.location.href = 'index.php?action=vista_trabajo_social&formulario=becas';
        }
      }
    ],
    "language": {
