 ...
 $('#tipo_reporte').change(function() {
  ...
  $(document).ready(function() {
    const tableMed = $('#tabla_medicina').DataTable({
      "responsive": true,
      "autoWidth": false,
      "paging": true,
      "lengthChange": true,
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          filteredData.forEach(item => {
            ...
            tableMed.row.add([fecha_formateada, nombresApellidos, item.cedula, item.nombre_pnf, item.estatura, item.peso, item.tipo_sangre, item.motivo_visita]);
          });
