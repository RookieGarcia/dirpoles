...
$('#tipo_reporte').change(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-select-beneficiario').forEach(button => {
      button.addEventListener('click', function() {
        ...
        document.getElementById('id_beneficiario').dispatchEvent(new Event("input"));
  ...
  $(document).ready(function() {
    const tableD = $('#tabla_discapacidad').DataTable({
      "responsive": true,
      "autoWidth": false,
      "paging": true,
      "lengthChange": true,
    ...
    $('#form-reporte').submit(function(e) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if ($('#tipo_reporte').val() === 'morbilidad' && validarFechaManual("fecha_inicio", "error_fecha_inicio") && validarFechaManual("fecha_fin", "error_fecha_fin") || $('#tipo_reporte').val() === 'morbilidad' && $('fecha_inicio').val() === '' && $('fecha_fin').val() === '' || $('#tipo_reporte').val() === 'por_beneficiario' && validarFechaManual("fecha_inicio", "error_fecha_inicio") && validarFechaManual("fecha_fin", "error_fecha_fin") || $('#tipo_reporte').val() === 'por_beneficiario' && $('fecha_inicio').val() === '' && $('fecha_fin').val() === '') {
            ...
            filteredData.forEach(item => {
              ...
              tableD.row.add([fecha_formateada, nombresApellidos, item.cedula, item.nombre_pnf, item.condicion_medica, item.cirugia_prev, item.requiere_asistencia, item.dispositivo_asistencia, item.apoyo_psicologico]);
            });
