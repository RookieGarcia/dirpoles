$(function () {
    var table = $('#tabla_citas').DataTable({
        ...
        "buttons": [
            ...
            {
                text: '<i class="fas fa-plus-circle"></i> Crear Cita',
                className: 'btn btn-info',
                action: function () {
                    window.location.href = 'index.php?action=citas_crear';
                }
            }
        ],
        "dom": 'Bfrtip',
        "language": {
            "sEmptyTable": "No hay registros de citas disponibles",
            "sInfo": "Mostrando _START_ a _END_ de _TOTAL_ citas",
            "sInfoEmpty": "Mostrando 0 a 0 de 0 citas",
            "sInfoFiltered": "(filtrado de _MAX_ citas totales)",
